...
statement = [[-119.02, -56.54, 1200, -80, -12.99, -550, -167.90, -5.58, -3.54, -9.99],
             ...
             [-101.44, -48.83, -19.99, -92.12, 1200, -
                 80, -67.33, -12.99, -550, -30.33],
             [-91.98, -45.65, -50, -9.99, 1200, -80, -
                 414.22, -12.99, -550, -9.29, -67.12],
             [-159.53, -27.61, -168.45, 1200, -80, -
                 12.99, -76.94, -550, -28.08, -27.89],
...
def update_statement(statement, initial_balance, interest_rate):
    ...
    for month in statement:
        ...
        tot_interest = tot_interest + \
            calculate_interest(balance, interest_rate)

    statement[-1].append(tot_interest)
    balance = balance + tot_interest
